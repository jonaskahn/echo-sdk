...
class PluginContract:
    """Contract defining the interface between ECHO core and a plugin.

    This class wraps a plugin class and provides a standardized interface
    for the ECHO core system to interact with plugins without directly
    ...
    def create_agent(self) -> BasePluginAgent:
        """Create an agent instance.

        Returns:
            BasePluginAgent: New agent instance
        """
