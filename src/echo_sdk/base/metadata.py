...
class ModelConfig:
    ...
    This replaces the direct dependency on echo.llm.providers.ModelConfig
...
class PluginMetadata:
    ...
    This defines all the information the ECHO core system needs to know
    ...
    langchain_version: str = ">=0.1.0"
    langgraph_version: str = ">=0.1.0"
